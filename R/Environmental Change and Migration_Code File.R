...
ggsave("plots/figure 2_violin_differences in environmental effects by hazards.jpg", dpi=600, width=8, height=6)
...
plot123    
ggsave("plots/figure 3_line plots_sample composition effects.jpg", width=15, height=5, dpi=600)
...
ggsave("plots/figure 4_map_predicted environmental migration.jpg", width = 10, height=4.5, dpi=600)
...
ggsave("plots/figure ED2_density_distribution of coefficients, between and within study variation.jpg", height=4, width = 7.5, dpi=600)
...
plot_comp_box
ggsave("plots/figure ED3a_boxplot_sample composition measures.jpg", plot = plot_comp_box, height=5, width=6.5)
...
plot_sample_map
ggsave("plots/figure ED3b_map_sample composition.jpg", plot = plot_sample_map, height=5, width=10)
...
ggsave("plots/figure s2_boxplot_distribution of standardized effects.svg", width = 7, height=7, dpi=600)
ggsave("plots/figure s2_boxplot_distribution of standardized effects.jpg", width = 7, height=7, dpi=600)
...
meta.sum <- meta %>% 
  ...
  stargazer(
    ...
    type = "html", 
    out = "output/table s3_summary statistics.doc"
  )
...
stargazer(r1b, r2b, r3b, r4b, r5b,
          type="html",
          out="output/table s4_robustness_only models with spatial fe.doc",
          ci=F, 
          notes="Test",
          model.names = T,
          single.row = T,
...
stargazer(r1b, r2b, r3b, r4b, r5b,
          type="html",
          out="output/table s5_robustness_only models with time fe.doc",
          ci=F, 
          notes="Test",
          model.names = T,
          single.row = T,
...
stargazer(r1b, r2b, r3b, r4b, r5b,
          type="html",
          out="output/table s6_robustness_random effects-mixed effects models.doc",
          ci=F, 
          notes="Test",
          model.names = T,
          single.row = T,
...
stargazer(r1b, r2b, r3b, r4b, r5b,
          type="html",
          out="output/table s7_robustness_including all control variables.doc",
          ci=F, 
          notes="Test",
          model.names = T,
          single.row = T,
...
stargazer(r1b, r2b, r3b, r4b, r5b,
          type="html",
          out="output/table s8_robustness_removing study lines with large effects 2sd.doc",
          ci=F, 
          notes="Test",
          model.names = T,
          single.row = T,
...
stargazer(r1b, r2b, r3b, r4b, r5b,
          type="html",
          out="output/table s9_robustness_only international migration.doc",
          ci=F, 
          notes="Test",
          model.names = T,
          single.row = T,
...
stargazer(r1b, r2b, r3b, r4b, r5b,
          type="html",
          out="output/table s10_robustness_alternative conflict measures.doc",
          ci=F, 
          notes="Test",
          model.names = T,
          single.row = T,
...
stargazer(clim1b, clim3b, clim5b, clim2b, clim4b,clim6b,
          type="html",
          out="output/table s11_extended_testing for interactions between env. variables.doc",
          ci=F, 
          notes="Test",
          model.names = T,
          single.row = T,
...
stargazer(m1b, m2b, 
          type="html",
          out="output/table s12_extended_environment as push and pull.doc",
          ci=F, 
          notes="Test",
          model.names = T,
          single.row = T,
...
stargazer(m1b, m2b, m3b, m4b, m5b,
          type="html",
          out="output/table s13_extended_testing for influence of different regional sample compositions.doc",
          ci=F, 
          notes="Test",
          model.names = T,
          single.row = T,
...
stargazer(abs1b, abs2b, abs3b, abs4b,abs5b,
          type="html",
          out="output/table s14_extended_absolute coefficients as outcome.doc",
          ci=F, 
          notes="Test",
          model.names = T,
          single.row = T,
...
stargazer(pred1b,
          type="html",
          out="output/table s15_extended_simplified main model for predictions.doc",
          ci=F, 
          notes="Test",
          model.names = T,
          single.row = T,
...
ggsave("plots/figure s4_map_observed environmental change.jpg", dpi=600)
...
ggsave('plots/figure s5_funnel plot_Standard errors against coefficient size.jpg', width=8, height=6,
       dpi=600)
...
stargazer(pu1b, pu2b, pu3b, pu4b, 
          type="html",
          out="ouptut/table s16_extended_testing for publication effects.doc",
          ci=F, 
          notes="Test",
          model.names = T,
          single.row = T,
